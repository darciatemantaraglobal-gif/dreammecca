...
import type {
  ...
  HealthStatus,
  ListAdminPackages200,
  ListPublicPackages200,
  LogoutSuccess,
 ...
 */
export const listPublicPackages = async ( options?: RequestInit): Promise<ListPublicPackages200> => {

  return customFetch<ListPublicPackages200>(getListPublicPackagesUrl(),
  {
    ...options,
    method: 'GET'
 ...
 */
export const listAdminPackages = async ( options?: RequestInit): Promise<ListAdminPackages200> => {

  return customFetch<ListAdminPackages200>(getListAdminPackagesUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListAdminPackagesQueryOptions = <TData = Awaited<ReturnType<typeof listAdminPackages>>, TError = ErrorType<ErrorEnvelope>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listAdminPackages>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type ListAdminPackagesQueryError = ErrorType<ErrorEnvelope>
...
export function useListAdminPackages<TData = Awaited<ReturnType<typeof listAdminPackages>>, TError = ErrorType<ErrorEnvelope>>(
 ...
 */
export const createPackage = async (packageInput: PackageInput, options?: RequestInit): Promise<CreatePackage201> => {

  return customFetch<CreatePackage201>(getCreatePackageUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const updatePackage = async (id: string,
    packageInput: PackageInput, options?: RequestInit): Promise<UpdatePackage200> => {

  return customFetch<UpdatePackage200>(getUpdatePackageUrl(id),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdatePackageMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePackage>>, TError,{id: string;data: BodyType<PackageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updatePackage>>, TError,{id: string;data: BodyType<PackageInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updatePackage>>, {id: string;data: BodyType<PackageInput>}> = (props) => {
          const {id,data} = props ?? {};
...
export const useUpdatePackage = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updatePackage>>, TError,{id: string;data: BodyType<PackageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {id: string;data: BodyType<PackageInput>},
        TContext
      > => {
 ...
 */
export const deletePackage = async (id: string, options?: RequestInit): Promise<LogoutSuccess> => {

  return customFetch<LogoutSuccess>(getDeletePackageUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getCreateDepartureUrl = (packageId: string,) => {




  return `/api/admin/packages/${packageId}/departures`
}

/**
 * @summary Add a departure date to a package (admin only)
 */
export const createDeparture = async (packageId: string,
    departureInput: DepartureInput, options?: RequestInit): Promise<CreateDeparture201> => {

  return customFetch<CreateDeparture201>(getCreateDepartureUrl(packageId),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(departureInput)
  }
);}
...
export const getCreateDepartureMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createDeparture>>, TError,{packageId: string;data: BodyType<DepartureInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createDeparture>>, TError,{packageId: string;data: BodyType<DepartureInput>}, TContext> => {

const mutationKey = ['createDeparture'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createDeparture>>, {packageId: string;data: BodyType<DepartureInput>}> = (props) => {
          const {packageId,data} = props ?? {};

          return  createDeparture(packageId,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateDepartureMutationResult = NonNullable<Awaited<ReturnType<typeof createDeparture>>>
    export type CreateDepartureMutationBody = BodyType<DepartureInput>
    export type CreateDepartureMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Add a departure date to a package (admin only)
 */
export const useCreateDeparture = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createDeparture>>, TError,{packageId: string;data: BodyType<DepartureInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createDeparture>>,
        TError,
        {packageId: string;data: BodyType<DepartureInput>},
        TContext
      > => {
      return useMutation(getCreateDepartureMutationOptions(options));
    }

export const getUpdateDepartureUrl = (id: string,) => {




  return `/api/admin/departures/${id}`
}

/**
 * @summary Update a departure (admin only)
 */
export const updateDeparture = async (id: string,
    departureInput: DepartureInput, options?: RequestInit): Promise<UpdateDeparture200> => {

  return customFetch<UpdateDeparture200>(getUpdateDepartureUrl(id),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateDepartureMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDeparture>>, TError,{id: string;data: BodyType<DepartureInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateDeparture>>, TError,{id: string;data: BodyType<DepartureInput>}, TContext> => {

const mutationKey = ['updateDeparture'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateDeparture>>, {id: string;data: BodyType<DepartureInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateDeparture(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateDepartureMutationResult = NonNullable<Awaited<ReturnType<typeof updateDeparture>>>
    export type UpdateDepartureMutationBody = BodyType<DepartureInput>
    export type UpdateDepartureMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Update a departure (admin only)
 */
export const useUpdateDeparture = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDeparture>>, TError,{id: string;data: BodyType<DepartureInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateDeparture>>,
        TError,
        {id: string;data: BodyType<DepartureInput>},
        TContext
      > => {
      return useMutation(getUpdateDepartureMutationOptions(options));
    }

export const getDeleteDepartureUrl = (id: string,) => {
 ...
 */
export const deleteDeparture = async (id: string, options?: RequestInit): Promise<LogoutSuccess> => {

  return customFetch<LogoutSuccess>(getDeleteDepartureUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteDepartureMutationOptions = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteDeparture>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteDeparture>>, TError,{id: string}, TContext> => {

const mutationKey = ['deleteDeparture'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteDeparture>>, {id: string}> = (props) => {
          const {id} = props ?? {};

          return  deleteDeparture(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteDepartureMutationResult = NonNullable<Awaited<ReturnType<typeof deleteDeparture>>>

    export type DeleteDepartureMutationError = ErrorType<ErrorEnvelope>

    /**
 * @summary Delete a departure (admin only)
 */
export const useDeleteDeparture = <TError = ErrorType<ErrorEnvelope>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteDeparture>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteDeparture>>,
        TError,
        {id: string},
        TContext
      > => {
      return useMutation(getDeleteDepartureMutationOptions(options));
    }
