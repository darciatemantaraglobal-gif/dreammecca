  ...
  return (
    <article
      ...
      style={{
        ...
        border: pkg.featured ? '1px solid #F2E9E4' : '1px solid rgba(27,27,54,0.12)',
    ...
    >
      <figure className="relative aspect-[16/9] overflow-hidden" style={{ background: '#090F3B' }}>
        ...
        <div className="absolute inset-x-[12px] top-[12px] flex items-start justify-between gap-[8px] md:inset-x-[16px] md:top-[16px]">
          <span className="rounded-md px-[8px] py-[4px] text-[9px] font-bold md:text-[11px]" style={pkg.tier === 'Eksklusif' ? { background: '#F6EEDC', color: '#F2E9E4' } : { background: '#fff', color: '#090F3B' }}>
            {pkg.tier}
          </span>
      ...
      <div className="flex flex-1 flex-col p-[14px] md:p-[22px]">
        <p className="flex items-center gap-[6px] text-[10px] leading-[1.35] md:gap-[8px] md:text-[13px]" style={{ color: '#5D5D76' }}>
          <CalendarDays size={13} color="#F2E9E4" />
          {pkg.dateLabel}
        </p>
        ...
        <div className="mt-[14px] space-y-[7px] text-[10px] leading-[1.4] md:mt-[18px] md:space-y-[10px] md:text-[13px] md:leading-[1.45]" style={{ color: '#444761' }}>
          <div className="flex gap-[7px] md:gap-[10px]"><Clock3 size={14} className="mt-[1px] flex-none md:size-4" color="#F2E9E4" /><span>{pkg.duration}</span></div>
          <div className="flex gap-[7px] md:gap-[10px]"><Plane size={14} className="mt-[1px] flex-none md:size-4" color="#F2E9E4" /><span>{pkg.airline}</span></div>
          <div className="hidden gap-[7px] md:flex md:gap-[10px]"><Hotel size={16} className="mt-[1px] flex-none" color="#F2E9E4" /><span>{pkg.makkah}</span></div>
          <div className="hidden gap-[7px] md:flex md:gap-[10px]"><Hotel size={16} className="mt-[1px] flex-none" color="#F2E9E4" /><span>{pkg.madinah}</span></div>
          <div className="hidden gap-[7px] md:flex md:gap-[10px]"><TrainFront size={16} className="mt-[1px] flex-none" color="#F2E9E4" /><span>Kereta Cepat Haramain</span></div>
        </div>
...
function WaitlistCard() {
  ...
  return (
    <div className="mt-[40px] max-w-[620px] rounded-xl p-[28px] md:p-[36px]" style={{ background: '#F7F6F2', border: '1px solid #E5DDCC' }}>
      <span className="text-[13px] font-bold tracking-[0.10em] uppercase" style={{ color: '#F2E9E4' }}>November 2026</span>
    ...
    <section id="paket" className="px-[7vw] py-[72px] md:py-[132px]" style={{ background: '#F7F6F2' }}>
      <div className="mx-auto max-w-[1180px]">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeUp}>
          <span className="text-[12px] font-bold tracking-[0.14em] uppercase" style={{ color: '#F2E9E4' }}>Jadwal Umroh</span>
