  ...
  return (
    ...
    >
      <div className="max-w-[1180px] mx-auto">
        ...
        {/* JUDUL + DESKRIPSI — satu kolom, atas-bawah */}
        <motion.div
        ...
        >
          ...
          <p className="text-[16px] leading-[1.65] mt-[20px]" style={{ color: 'rgba(255,255,255,0.7)' }}>
          ...
          <div className="flex flex-wrap gap-[12px] mt-[28px]">
            <a
              href="#kontak"
              className="inline-flex items-center justify-center px-[28px] py-[15px] rounded-full font-bold text-[14px] no-underline hover:opacity-90 transition-opacity"
            ...
            <a
              href="#paket"
              className="inline-flex items-center justify-center px-[28px] py-[15px] rounded-full font-bold text-[14px] no-underline border transition-colors hover:bg-white/10"
        ...
        {/* VIDEO — di bawah judul+deskripsi */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.15, ease: [0.22, 1, 0.36, 1] }}
          className="w-full rounded-2xl overflow-hidden relative mt-[40px]"
        ...
        {/* LOGO PARTNER — strip tipis di bawah video */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          <div className="flex flex-wrap gap-x-[24px] gap-y-[8px] mt-[10px]">
            {partners.map(p => (
