...
export default function ProgramDetails() {
  ...
  return (
    <section id="rincian-program" className="mobile-compact-section bg-white px-[7vw] py-[72px] md:py-[112px]">
      <div className="mx-auto max-w-[1180px]">
        ...
        <div className="mt-[34px] grid grid-cols-1 gap-[12px] md:mt-[44px] md:grid-cols-2 md:gap-[16px]">
          <article className="rounded-lg p-[20px] md:p-[30px]" style={{ background: '#F7F6F2', border: '1px solid #E5DDCC' }}>
          ...
          <article className="rounded-lg p-[20px] md:p-[30px]" style={{ background: '#090F3B' }}>
